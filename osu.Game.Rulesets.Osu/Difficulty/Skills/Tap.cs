...
namespace osu.Game.Rulesets.Osu.Difficulty.Skills
{
    public static class Tap
    {
                                                                         ...
                                                                         double clockRate)
        {
            ...
            sw.WriteLine($"{hitObjects[0].StartTime / 1000.0} {currStrain[0]} {currStrain[1]} {currStrain[2]} {currStrain[3]} 0");
            sw.WriteLine($"{hitObjects[1].StartTime / 1000.0} {currStrain[0]} {currStrain[1]} {currStrain[2]} {currStrain[3]} 0");
