...
using osu.Game.Rulesets.Osu.Difficulty.Preprocessing.MovementCorrections;
...
namespace osu.Game.Rulesets.Osu.Difficulty.Preprocessing
{
    public class OsuMovement
    {
        ...
        {
            PrevObjectCorrection.Initialize();
            NextObjectCorrection.Initialize();
        }
                                                        ...
                                                        bool hidden = false, double noteDensity = 0, OsuHitObject objMinus1 = null, OsuHitObject objMinus2 = null)
        {
            ...
            var correction0 = PrevObjectCorrection.Calculate(obj0, t01, t12, d01, d12, s01, s12, out var flowiness012, out var obj1InTheMiddle);

            // Correction #2 - The Next Object
            // Estimate how obj3 affects the difficulty of hitting obj2
            var correction3 = NextObjectCorrection.Calculate(obj3, t12, t23, d12, d23, s12, s23, out var flowiness123, out var obj2InTheMiddle);
